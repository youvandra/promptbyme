      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-8">
        <div>
          <div className="flex items-center gap-3 mb-2">
            <Link to="/api" className="text-zinc-400 hover:text-white transition-colors">
              <ArrowLeft size={20} />
            </Link>
          ...
          <p className="text-zinc-400">
            Generate API code for your prompts and flows
          </p>
        </div>
        
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2 bg-zinc-900/50 border border-zinc-800/50 rounded-xl p-2">
            <button
              ...
              >
                ...
                <div className="w-full md:w-1/2 flex flex-col">
                  <div className="p-6 flex-1 overflow-y-auto">
                    ...
                    <div className="bg-zinc-800/50 p-4 rounded-lg h-[500px] overflow-auto">
