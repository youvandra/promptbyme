...
export const ProjectSpacePage: React.FC = () => {
 ...
 const InputNode = ({ data }: NodeProps) => (
  <div className="px-4 py-3 shadow-md rounded-lg bg-blue-600 border border-blue-500/30 w-[250px] h-[150px] hover:bg-blue-700 hover:border-blue-500/50 transition-all duration-200 flex flex-col">
    <div className="font-bold text-sm text-blue-300 mb-3">{data.label}</div>
     ...
     {data.content && (
      <div className="text-xs text-blue-200 bg-zinc-900 p-3 rounded border border-blue-500/20 overflow-y-auto flex-1">{data.content}</div>
     )}
   </div>
 )
 ...
 const ConditionNode = ({ data }: NodeProps) => (
  <div className="px-4 py-3 shadow-md rounded-lg bg-yellow-600 border border-yellow-500/30 w-[250px] h-[150px] hover:bg-yellow-700 hover:border-yellow-500/50 transition-all duration-200 flex flex-col">
    <div className="font-bold text-sm text-yellow-300 mb-3">{data.label}</div>
     ...
     {data.content && (
      <div className="text-xs text-yellow-200 bg-zinc-900 p-3 rounded border border-yellow-500/20 overflow-y-auto flex-1">{data.content}</div>
     )}
   </div>
 )

 const OutputNode = ({ data }: NodeProps) => (
  <div className="px-4 py-3 shadow-md rounded-lg bg-green-600 border border-green-500/30 w-[250px] h-[150px] hover:bg-green-700 hover:border-green-500/50 transition-all duration-200 flex flex-col">
    <div className="font-bold text-sm text-green-300 mb-3">{data.label}</div>
     ...
     {data.content && (
      <div className="text-xs text-green-200 bg-zinc-900 p-3 rounded border border-green-500/20 overflow-y-auto flex-1">{data.content}</div>
     )}
   </div>
 )
