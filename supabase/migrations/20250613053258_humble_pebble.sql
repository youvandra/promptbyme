/*
  # Add views tracking to prompts table

  1. New Columns
    - `views` (integer, default 0) - Track how many times a public prompt has been viewed

  2. Indexes
    - Add index on views column for efficient sorting by popularity

  3. Security
    - Add policy to allow anyone to increment view count for public prompts only
*/
