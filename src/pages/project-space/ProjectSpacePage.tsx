...
export const ProjectSpacePage: React.FC = () => {
 ...
 const InputNode = ({ data }: NodeProps) => (
  <div className="px-4 py-3 shadow-md rounded-lg bg-purple-600/20 border border-purple-500/30 w-[250px] h-[250px] hover:bg-purple-600/30 hover:border-purple-500/50 transition-all duration-200 flex flex-col">
 ...
 const PromptNode = ({ data }: NodeProps) => (
  <div className="px-4 py-3 shadow-md rounded-lg bg-blue-600/20 border border-blue-500/30 w-[250px] h-[250px] hover:bg-blue-600/30 hover:border-blue-500/50 transition-all duration-200 flex flex-col">
 ...
 const ConditionNode = ({ data }: NodeProps) => (
  <div className="px-4 py-3 shadow-md rounded-lg bg-yellow-600/20 border border-yellow-500/30 w-[250px] h-[250px] hover:bg-yellow-600/30 hover:border-yellow-500/50 transition-all duration-200 flex flex-col">
 ...
 const OutputNode = ({ data }: NodeProps) => (
  <div className="px-4 py-3 shadow-md rounded-lg bg-green-600/20 border border-green-500/30 w-[250px] h-[250px] hover:bg-green-600/30 hover:border-green-500/50 transition-all duration-200 flex flex-col">
