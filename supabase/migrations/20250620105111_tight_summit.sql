/*
  # Fix Project Structure and Team Collaboration

  1. Schema Changes
    - Add `team_audit_log` table for tracking team actions
    - Fix project_members table to properly track team membership
    - Add helper function to check project admin status
    - Add proper RLS policies for team collaboration

  2. Security
    - Enable RLS on all tables
    - Add policies for proper access control
    - Ensure project owners and admins can manage members
    - Allow users to view and manage their own memberships

  3. Performance
    - Add indexes for common query patterns
    - Optimize RLS policies to avoid recursion
*/
