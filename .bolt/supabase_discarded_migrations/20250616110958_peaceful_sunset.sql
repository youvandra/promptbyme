/*
  ...
  3. Data Integrity
    ...
    - Fix any potential cascade issues
*/
...
CREATE INDEX IF NOT EXISTS idx_project_invitations_accepted ON project_invitations(accepted_at);
...
CREATE INDEX IF NOT EXISTS idx_project_prompts_added_at ON project_prompts(added_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_prompt_comments_deleted ON prompt_comments(is_deleted);
