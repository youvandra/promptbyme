...
BEGIN
  ...
  -- Drop policies that depend on the functions first
...
-- Recreate policies for flow_nodes using the helper functions
...
-- Recreate policies for flow_connections using the helper functions
