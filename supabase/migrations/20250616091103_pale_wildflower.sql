/*
  # Complete Team Projects Collaboration Feature

  1. Database Schema
    - `projects` table for project management
    - `project_members` table for membership and roles
    - `project_invitations` table for secure invites
    - `project_prompts` table to link prompts to projects
    - `prompt_comments` table for threaded discussions

  2. RLS Policies (Recursion-Safe)
    - Direct ownership checks without cross-table references
  ...
  3. Security Features
    ...
    - Project-scoped comments and prompts
*/
...
-- ============================================================================
-- PROJECTS TABLE POLICIES (No circular dependencies)
-- ============================================================================
...
-- ============================================================================
-- PROJECT MEMBERS TABLE POLICIES (No circular dependencies)
-- ============================================================================
...
-- Users can delete invitations for projects they manage
